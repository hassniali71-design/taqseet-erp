...
const NAV_ITEMS = [
  ...
  { to: "/collections", label: "التحصيل" },
  { to: "/suppliers", label: "الموردون" },
  { to: "/purchases/new", label: "شراء جديد" },
  { to: "/treasury", label: "الخزينة" },
  { to: "/expenses", label: "المصروفات" },
  { to: "/accounting", label: "المحاسبة" },
  { to: "/exchanges/new", label: "استبدال" },
  { to: "/deliveries", label: "التوصيل" },
