    ...
    <div className="flex min-h-screen bg-background">
      ...
      <main className="flex-1 mx-auto max-w-2xl px-4 py-8">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          للقراءة فقط، محسوب من تاريخ البيع (نقدي أو تقسيط) + مدة ضمان المنتج، بدون أي كيان مخزّن
          منفصل. البحث عام: بالاسم أو الكود أو الماركة أو الموديل أو رقم السيريال — الأجهزة اللي
          بدون سيريال بتظهر برضو بنفس الطريقة.
        </p>
